(function() {
  ...
  console.log('cast-button.js loaded on:', window.location.href);
  ...
  function createCastButton(video) {
    ...
    console.log('Creating cast button for video:', video.src || video.currentSrc);
    ...
    btn.className = 'chromecast-btn visible';
    btn.title = 'Cast to Chromecast';
    btn.style.cssText = 'pointer-events: auto; position: absolute; bottom: 70px; right: 10px; z-index: 10000;';
    ...
    tooltip.className = 'chromecast-tooltip visible';
    tooltip.textContent = 'Click to cast';
    tooltip.style.cssText = 'position: absolute; bottom: 120px; right: 5px; background: #333; color: white; padding: 6px 12px; border-radius: 4px; font-size: 12px; z-index: 10000;';
